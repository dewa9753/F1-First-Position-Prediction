...
- Feature examples: qualifying lap time, grid position, team/driver season form, circuit characteristics
...
- 28% accuracy, 26% F1 in predicting the final position of a given driver in any race
- the model provides 20% more accuracy than a random guess since the model only considers final positions of less than 13
